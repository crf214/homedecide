...
// color: active text+icon color, bg: active background tint
const NAV = [
  { href: '/dashboard',            label: 'Overview',    icon: '◈', color: '#2563eb', bg: '#eff6ff' },
  { href: '/dashboard/properties', label: 'Properties',  icon: '⌂', color: '#2563eb', bg: '#eff6ff' },
  { href: '/dashboard/evaluate',   label: 'Evaluate',    icon: '✦', color: '#059669', bg: '#ecfdf5' },
  { href: '/dashboard/rankings',   label: 'Rankings',    icon: '◉', color: '#059669', bg: '#ecfdf5' },
  { href: '/dashboard/criteria',   label: 'Criteria',    icon: '⊞', color: '#9333ea', bg: '#faf5ff' },
  { href: '/dashboard/formula',    label: 'Formula',     icon: '∑', color: '#9333ea', bg: '#faf5ff' },
]
